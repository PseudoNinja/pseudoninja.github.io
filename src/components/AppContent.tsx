...
const AppContent = () => {
    ...
    return (
        <main
            id="app-content"
            className="app-content overflow-y-auto grow flex flex-col border-none mb-4 sm:mb-0"
        >
            <div
                id="hero-image-container"
                className="bg-picton-blue-500 h-32 flex justify-center overflow-visible mb-20 sm:hidden"
            >
            ...
            <Panel id="about" title={app.lang.translate("Who Am I")}>
                <p>
                    {app.lang.translate(
                        "Hi, my name is Eric Miller and I am a Full-stack Engineer with over 20 years of experience driving success across diverse industries. He is a Proven leader with 10 years of experience in building high-performing teams, delivering complex projects, and exceeding business goals. I am currently seeking a challenging leadership or Solutions Architect role where I can leverage my diverse skills and experience to make a significant impact."
                    )}
                </p>
